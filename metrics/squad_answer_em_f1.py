...
class SquadAnswerEmF1Metric(Metric):
    ...
    def __call__(
        ...
        self._count += 1
        if self.save_all:
            self._all_em[hash_id] = int(exact_scores)
            self._all_f1[hash_id] = f1_scores
    ...
    def get_metric(self, reset: bool = False) -> Tuple[float, float]:
        ...
        if self.save_all:
            ...
            ret = {"em": round(exact_match, 5), "f1": round(f1_score, 5), "count": self._count}
        return ret
